...
logger = logging.getLogger("monitoring.diagnosis")
...
def _get_prompt_content(prompt_name: str) -> str | None:
    ...
    try:
        ...
        # monitoring 的 prompts 表可能还没导入这些 prompt（首次运行）
...
def _generate_diagnosis(
    ...
    prompt_text = _DIAGNOSIS_PROMPT.format(
        ...
        prompt_content=prompt_content or "(prompt 内容未导入 monitoring，请基于维度泛泛分析)",
    )
