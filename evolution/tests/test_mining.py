...
class MiningTest(unittest.TestCase):
    ...
    def test_mine_signature_with_mock_llm(self) -> None:
        ...
        with patch("app.core.llm.chat", return_value=fake_response), \
             patch("app.core.llm.judge_enabled", return_value=True):
        ...
        # badcase 已关联到签名
        from app.diagnosis import mining as m
        bcs = m.list_badcases()
    ...
    def test_match_signature_single_candidate_no_llm(self) -> None:
        ...
        with patch("app.core.llm.judge_enabled", return_value=False):
            sig_id = mining.match_signature("content", "novel", "爽点密度", "新证据")
